...
- [ ] **[toi]** Essayer les **renvois de bus à bus** (issue #1, branche `feature/bus-to-bus-sends`) : page FX, tranche 8, DLY→BUS3 et REV→BUS3. Dire si ça suffit ou s'il faut empiler des effets dans un bus.
