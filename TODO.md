...
- [ ] **Même plugin d'insert, pas de coupure** (PRD § 5.8) : même plugin sur la même tranche dans les deux morceaux → il reste branché, seuls ses réglages changent ; l'avertissement à l'armement ne parle plus de ce cas.
